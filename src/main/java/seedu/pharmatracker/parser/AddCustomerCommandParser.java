...
public class AddCustomerCommandParser implements Parser<AddCustomerCommand> {
     ...
     * @throws PharmaTrackerException If the user input does not conform to the expected format,
     * if required flags are missing, or if invalid values are provided.
     */
    @Override
